...
class Scraping_agent:
    ...
    def __init__(self, access_token, client_id, client_secret, graph_domain='https://graph.facebook.com/',
                 graph_version='v10.0', debug='no') -> None:
        ...
        print(page_info['json_data']['data'][0]['id'])
