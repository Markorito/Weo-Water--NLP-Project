...
class Results:
    ...
    def get_countries(self):
        ...
        [{'countryCode': 'CN',
          ...
          'stateGeoNameId': ''}]
        """
        countries = self.results["results"]["places"]["focus"]["countries"]
        return countries
    ...
    def get_cities(self):
        ...
        """
        countries = self.results["results"]["places"]["focus"]["cities"]
        return countries
    ...
    def get_states(self):
        ...
        [{'countryCode': 'CN',
          ...
          'stateGeoNameId': '1796231'}]
        """
        countries = self.results["results"]["places"]["focus"]["states"]
        return countries
